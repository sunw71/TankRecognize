...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 22:44:38 2019
...
#testPaths = list(paths.list_images(config.TEST_IMAGES))
#testLabels = [p.split(os.path.sep)[2].split(".")[0] for p in testPaths]
#le = LabelEncoder()
#trainLabels = le.fit_transform(testLabels)
